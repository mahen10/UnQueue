...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="menuForm()">
    ...
    <form action="{{ route('owner.menu-items.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
        @csrf
