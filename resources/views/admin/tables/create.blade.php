...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center gap-4 mb-6">
        <a href="{{ route('admin.tables.index') }}" class="text-gray-500 hover:text-gray-900">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.tables.store') }}" method="POST" class="space-y-5">
            ...
            <div class="pt-4 border-t border-gray-100">
                <button type="submit" class="w-full sm:w-auto bg-blue-600 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-blue-700">Simpan Meja</button>
            </div>
        </form>
    </div>
</div>
